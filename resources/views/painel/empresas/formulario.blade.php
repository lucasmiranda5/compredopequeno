        ...
        <div class="col-md-12">
            ...
            @foreach($cidades as $cidade)
              <div class="row">
                  ...
                  <div class="col-md-3">
                      Atende: <input type="checkbox" name="atende[{{ $cidade['id'] }}]" value='S' {{ ( ($acao == 'Editar' and $cidEmpresa[$cidade['id']]['atende'] == "S") ? 'checked' : '') }}>
                  </div> 
                  <div class="col-md-3">
                    Entrega: <input type="checkbox" name="entrega[{{ $cidade['id'] }}]" value='S' {{ ( ($acao == 'Editar' and $cidEmpresa[$cidade['id']]['entrega'] == "S") ? 'checked' : '') }}>
                </div>
                <div class="col-md-3">
                 Tx Entrega: <input type="text" name="tx[{{ $cidade['id'] }}]" value="{{ $cidEmpresa[$cidade['id']]['tx'] ?? '' }}" class="form-control">
              </div>
                </div>
            @endforeach
            <div class="form-group">
